...
int useReflectionProbeOnCurrentCamera = 1;
float deferredAmbientBrightness = 0.9;
float deferredAmbientTint = 0.7;
...
float3 legacyAmbientColor = float3(1,1,1);
...
half4 frag (unity_v2f_deferred i) : SV_Target
{
    ...
    float blendDistance = unity_SpecCube0_ProbePosition.w; // will be set to blend distance for this probe
