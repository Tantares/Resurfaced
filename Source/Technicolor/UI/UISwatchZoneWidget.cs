...
namespace Technicolor
{
  public class UISwatchZoneWidget : MonoBehaviour
  {
    ...
    [SerializeField]
    protected GameObject _settingsPopup;

    [SerializeField]
    protected Toggle _autoToggle;
    [SerializeField]
    protected Toggle _restrictToggle;

    [SerializeField]
    protected Text _autoToggleText;
    [SerializeField]
    protected Text _restrictToggleText;
    [SerializeField]
    protected UISwatchSlotButton _primarySlotButton;
    [SerializeField]
    protected UISwatchSlotButton _secondarySlotButton;
    ...
    {
      _autoToggleText.text = Localizer.Format("#LOC_Technicolor_UI_SwatchSlotWidget_AutomaticColorsToggle_Title");
      _restrictToggleText.text = Localizer.Format("#LOC_Technicolor_UI_SwatchSlotWidget_RestrictColorsToggle_Title");
    }
    protected void SetupTooltips(Transform root, Tooltip_Text prefab)
    {
      Tooltips.AddTooltip(_settingsButton.gameObject, prefab, Localizer.Format("#LOC_Technicolor_UI_Tooltip_Settings"));
      Tooltips.AddTooltip(_autoToggle.gameObject, prefab, Localizer.Format("#LOC_Technicolor_UI_Tooltip_AutomaticColors"));
      Tooltips.AddTooltip(_restrictToggle.gameObject, prefab, Localizer.Format("#LOC_Technicolor_UI_Tooltip_RestrictColors"));
    }
