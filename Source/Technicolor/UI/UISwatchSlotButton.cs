...
namespace Technicolor
{
  public class UISwatchSlotButton
  {
    ...
    protected void SetupTooltips(Transform root, Tooltip_Text prefab)
    {
      ...
      {
        _tooltip = Tooltips.AddTooltip(root.gameObject, prefab,
    ...
    {
      return _swatchButton.transform.position + new Vector3(_swatchButton.GetComponent<RectTransform>().sizeDelta.x * 2f, 0, 0);
    }
